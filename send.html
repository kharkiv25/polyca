...
$name = $_POST['name'];
$phone = $_POST['phone'];
$product = 'полиця';  //<<<  В КАВЫЧКАХ НАЗВАНИЕ ТОВАРА
$discount = $_POST['discount'];
$ip_r = $_SERVER['REMOTE_ADDR'];
$date = date("Y-m-d / H:i:s");
//******ПОЧТА ****************
            $to = 'xxxxxxxxxx'; //ЗДЕСЬ ПИШИТЕ ВАШУ ПОЧТУ(НЕ ОБЯЗАТЕЛЬНО)
            $subject = 'Новая заявка с сайта'; //Заголовок сообщения
            $message = "Имя: {$name}\nТелефон: {$phone}\nТовар: {$product}\nЗаказано с лендинга: {$_SERVER['HTTP_REFERER']}\nIP адрес клиента: {$ip_r}\nВремя заказа: {$date}";
			
            $headers  = "Content-type: text/html; charset=utf-8 \r\n"; 
            
            mail($to, $subject, $message, $headers); 
//********ТЕЛЕГРАММ**********************************************************
$token = "7542716968:AAFKQ4yfgBgM1WYSC8qx2O_eHBNb99SIuJw"; /*<сюда вставляете токен вашего бота*/
$chat_id = "423937462";   /*< сюда ваш id чата - id можно узнать с помощью этого бота   @username_to_id_bot   */
$arr = array(
  'Заказ на - ' => $product,
  //'Кол-во: ' => $discount,
  '********************' => $style,
...
<!-- End Facebook Pixel Code -->
 ...
 <body>
        ...
        <div class="block_success">
             <h2 style="text-transform: uppercase;">Дякуємо за замовлення!<br />Ваша заявка прийнята!</h2>
             <p class="success">
                 Найближчим часом з вами зв'яжеться оператор для підтвердження замовлення. Будь ласка, увімкніть контактний телефон.
             </p>
<p class="perenapravl">
             Ви вказали такі дані для зворотного зв'язку:<br><br></p>
<p class="perenapravl1">Ім'я:
<?php
  echo $_POST['name'];
  ?><br>
  Телефон:
  ...
  <p style="text-align:center"><span style="color:#e74c3c">- Якщо ви помилилися під час заповнення даних,&nbsp; будь ласка</span></p>

<p style="text-align:center"><a href="/">заповніть заявку ще раз</a></p>
<br>
<br>
<br>
